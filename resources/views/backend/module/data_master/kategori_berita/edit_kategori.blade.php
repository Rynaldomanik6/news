...
<div class="row">
    <div class="col-xl-12">
        <section class="hk-sec-wrapper">
            <h5 class="hk-sec-title">Edit Kategori berita</h5><br><br>
            <div class="row">
                <div class="col-sm">
                    <form action="{{ URL::to('ubah_kategori_berita') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $data->id }}">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="kategori_berita">Kategori berita</label>
                                <input class="form-control" type="text" name="kategori_berita" value="{{ $data->kategori_berita }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
