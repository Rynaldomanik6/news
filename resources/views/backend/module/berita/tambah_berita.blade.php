    ...
    <div class="col-md-6">
        <nav class="hk-breadcrumb" aria-label="breadcrumb" style="margin-top: -30px;">
            <ol class="breadcrumb breadcrumb-light bg-transparent">
                <li class="breadcrumb-item"><a href="{{ URL::to('d_berita') }}">Berita</a></li>
...
<div class="row">
    <div class="col-xl-12">
        <section class="hk-sec-wrapper">
            <h5 class="hk-sec-title">Tambah Berita</h5><br><br>
            <div class="row">
                <div class="col-sm">
                    <form action="{{ URL::to('tambah_berita') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="tinymce-wrap">
                                    <textarea class="tinymce" name="isi_berita"></textarea>
                                </div>
                            </div><br>
